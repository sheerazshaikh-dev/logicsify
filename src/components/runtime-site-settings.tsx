...
function applyTheme(settings: PublicThemeSettings) {
  const root = document.documentElement;
  const set = (name: string, value: string | number | undefined, suffix = "") => {
    if (value !== undefined && value !== null && value !== "") root.style.setProperty(name, `${value}${suffix}`);
  };
  ...
  set("--theme-heading-font", settings.heading_font ? `"${settings.heading_font}", ui-sans-serif, system-ui, sans-serif` : undefined);
  set("--theme-body-font", settings.body_font ? `"${settings.body_font}", ui-sans-serif, system-ui, sans-serif` : undefined);
