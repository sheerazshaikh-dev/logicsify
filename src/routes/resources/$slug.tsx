...
export const Route = createFileRoute("/resources/$slug")({
  ...
  head: ({loaderData,params}) => ({
    meta: [
      { title: loaderData?.resource.seo_json?.title || `${loaderData?.resource.title || "Resource"} | Logicsify` },
      ...
      { property: "og:url", content: `https://logicsify.com/resources/${params.slug}` },
    ...
    links: [{ rel: "canonical", href: loaderData?.resource.seo_json?.canonical || `https://logicsify.com/resources/${params.slug}` }],
  }),
});
