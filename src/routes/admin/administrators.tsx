                  ...
                  <tr key={item.id} className="border-b border-slate-100 hover:bg-slate-50/70">
                    <td className="px-5 py-4">
                      ...
                      >
                        ...
                        <span>
                          <span className="block text-sm font-semibold text-ink hover:text-brand-red">
                            {item.name}
                          </span>
...
function RoleCard({
  ...
  return (
    <AdminCard className="p-5">
      <span className="grid h-10 w-10 place-items-center rounded-xl bg-slate-100 text-ink">
